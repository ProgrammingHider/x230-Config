...
* *awesomewm config (https://github.com/ProgrammingHider/yetmoredots)*
* *awesomewm widget (https://github.com/streetturtle/awesome-wm-widget)*
* *SeaBIOS Bootsplash (https://github.com/notthebee/seabiosbootsplash)*
* *skulls Coreboot (https://github.com/merge/skulls)*
* *Suckless Terminal (https://github.com/lukesmithxyz/st)*

Dependencies
--------------------------------------
* Debian 10 "Buster" w/ nonfree firmware (Base System)
* xorg Group Package (X11 Server)
* libx11-dev, libxft-dev (Dependency of st)
* git, build-essential (Dependency of st and Repository Download)
* arc-icon-theme, arc-theme, papirus-icon-theme (Dependency of awesome theme and widgets)
* nitrogen, compton (Dependency of awesome Autostart.sh)
* spotify-cli (Dependency of awesome widgets)
...
Installing skulls Coreboot (from merge/skulls/x230)
---------------------------------------
...
overwrite the `splashscreen.jpg` with your own JPEG
